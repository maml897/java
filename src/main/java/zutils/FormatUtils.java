...
public class FormatUtils
{
	public static void main(String[] args)
	{
		...
		System.out.println(double2String(162.535d));
		;
	...
	public static float division(float a, float b, int scale, boolean... multiply100)
	{
		...
		{
			return new BigDecimal(String.valueOf(a)).divide(new BigDecimal(String.valueOf(b)), scale, BigDecimal.ROUND_HALF_UP).floatValue();
		}
		return new BigDecimal(String.valueOf(a)).divide(new BigDecimal(String.valueOf(b)), scale + 2, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal("100")).floatValue();
	}

	/**
	 * 四舍五入 和formatFloat效果一致
	 * @param value
	 * @return
	 */
